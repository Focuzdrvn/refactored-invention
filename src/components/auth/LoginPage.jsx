...
const LoginPage = () => {
  const { loginWithGoogle, user, role, loading } = useAuth();
  ...
  if (loading || isLoggingIn) {
    return <LoadingSpinner size="lg" message="Signing you in..." />;
  }
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-8 transform transition-all duration-300 hover:scale-[1.02]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/80 text-lg">Voter Login</p>
          </div>
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-800 px-6 py-4 rounded-xl font-semibold flex items-center justify-center gap-3 transform transition-all duration-200 hover:scale-105 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
          ...
          <div className="mt-8 text-center space-y-3">
            <div className="flex items-center gap-2 justify-center text-white/70 text-sm">
              ...
              <span>Only registered E-Cell members can vote</span>
            </div>
